...
function translateFromWeb(from, to, text) {
    var doc = connect('https://engine2-async.reverso.net/WebReferences/WSAJAXInterface.asmx/TranslateCorrWS')
        .requestBody("{'searchText': '" + text.replaceAll("\\bi\\b", "I").replace("'", "\\'") + "', 'direction': '" + from + "-" + to + "-2', 'maxTranslationChars':'-1', 'usecorr':'true'}")
